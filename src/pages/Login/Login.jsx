...
import styles from "./Login.module.css"; // misma importacion del css pero usando el styles.
        ...
        >
          ...
          <form className="login-form" onSubmit={handleLogin}>
            ...
            <a
              ...
              className="forgot-password d-block mb-3"
            >
              ¿Olvidaste tu contraseña?
            </a>
            <a href="/sign_up" className="forgot-password d-block mb-3">
              ¿No tienes cuenta? Registrate aquí
            </a>

            <button
              type="submit"
              className={`btn w-100 ${styles.loginButton}`} // Aplica la clase de módulo
            >
              Log In
            </button>
          </form>
